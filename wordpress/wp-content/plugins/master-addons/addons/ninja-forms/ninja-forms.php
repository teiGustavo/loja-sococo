...
class JLTMA_Ninja_Form extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'validation_errors', [
        ...
        /*	STYLE TAB
        			/*-----------------------------------------------------------------------------------*/
        $this->start_controls_section( 'ma_ninja_form_section_style', [
            'label' => esc_html__( 'Design Layout', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_ninja_form_layout_style', [
        ...
        $this->add_control( 'field_bg_color_focus', [
            ...
            'default'   => '',
            'selectors' => [
                '{{WRAPPER}} .jltma-ninja-form .nf-field input:focus, {{WRAPPER}} .jltma-ninja-form .nf-field textarea:focus' => 'background-color: {{VALUE}}',
            ],
        ] );
        $this->add_group_control( Group_Control_Border::get_type(), [
        ...
        $this->add_responsive_control( 'radio_checkbox_border_width', [
        ...
        $this->add_control( 'radio_checkbox_border_color', [
         ...
         * -------------------------------------------------
         */
        $this->start_controls_section( 'section_required_notice_style', [
            'label' => __( 'Required Fields Notice', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'required_notice_text_color', [
            'label'     => __( 'Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '',
            'selectors' => [
        ...
        $this->add_responsive_control( 'required_notice_spacing', [
            'label'      => __( 'Spacing', 'master-addons' ),
            'type'       => Controls_Manager::SLIDER,
            'range'      => [
                'px' => [
        ...
        $this->add_control( 'validation_errors_heading', [
            'label'     => __( 'Validation Errors', 'master-addons' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
            'condition' => [
        ...
        $this->add_control( 'validation_error_description_color', [
        ...
        $this->add_control( 'validation_error_field_input_border_color', [
    ...
    protected function render() {
        ...
        if ( !class_exists( 'Ninja_Forms' ) ) {
            Master_Addons_Helper::jltma_elementor_plugin_missing_notice( array(
                'plugin_name' => esc_html__( 'Ninja Forms', 'master-addons' ),
            ) );
            return;
        }
        $this->add_render_attribute( 'jltma-ninja-form', 'class', [
            'jltma-contact-form',
            'jltma-ninja-form',
            'ma-cf',
            'ma-cf-' . esc_attr( $settings['ma_ninja_form_layout_style'] )
        ] );
        $this->add_render_attribute( 'jltma-ninja-form', 'id', ['jltma-ninja-form-' . get_the_ID()] );
        ...
        if ( class_exists( 'Ninja_Forms' ) ) {
            if ( !empty( $settings['contact_form_list'] ) ) {
                ?>
				<div <?php 
                echo $this->get_render_attribute_string( 'jltma-ninja-form' );
                ?>>
					<?php 
