...
class JLTMA_Animated_Headlines extends Widget_Base {
    ...
    protected function register_controls() {
         ...
         */
        $this->start_controls_section( 'ma_el_headlines_content', [
            'label' => esc_html__( 'Content', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_headlines_style_preset', [
            ...
            'description' => sprintf( '7+ more effects on <a href="%s" target="_blank">%s</a>', esc_url_raw( admin_url( 'admin.php?page=master-addons-settings-pricing' ) ), __( 'Upgrade Now', 'master-addons' ) ),
        ] );
        $this->add_control( 'ma_el_headlines_first_heading', [
        ...
        $repeater->add_control( 'ma_el_headlines_second_heading', [
        ...
        $this->add_responsive_control( 'ma_el_headlines_alignment', [
         ...
         */
        $this->start_controls_section( 'jltma_section_animated_headlines_settings', [
        ...
        // Bar Effect
        $this->add_control( 'bar_anim_delay', [
            'label'              => esc_html__( 'Animation Delay', 'master-addons' ),
            'type'               => Controls_Manager::NUMBER,
            'default'            => 3800,
            'frontend_available' => true,
        ...
        // Letter Effect
        $this->add_control( 'letters_anim_delay', [
        ...
        //Type Effect
        $this->add_control( 'type_anim_delay', [
        ...
        $this->add_control( 'type_selection_delay', [
        ...
        // Clip Effect
        $this->add_control( 'clip_reveal_delay', [
        ...
        $this->add_control( 'clip_anim_duration', [
         ...
         */
        $this->start_controls_section( 'ma_el_headlines_first_heading_styles', [
            'label' => esc_html__( 'First Heading', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_headlines_first_text_color', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#ffffff',
            'selectors' => [
                '{{WRAPPER}} .jltma-animated-heading .jltma-animated-heading-wrapper .jltma-animated-heading-title .first-heading' => 'color: {{VALUE}};',
            ],
        ] );
        $this->add_control( 'ma_el_headlines_first_bg_color', [
            'label'     => __( 'Background', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#704aff',
            'selectors' => [
                '{{WRAPPER}} .jltma-animated-heading .jltma-animated-heading-wrapper .jltma-animated-heading-title .first-heading' => 'background-color: {{VALUE}};',
            ],
        ] );
        ...
        $this->add_control( 'ma_el_headlines_first_heading_padding', [
        ...
        $this->add_control( 'ma_el_headlines_first_heading_margin', [
        ...
        $this->add_control( 'ma_el_headlines_first_heading_radius', [
         ...
         */
        $this->start_controls_section( 'ma_el_headlines_second_heading_styles', [
            'label' => esc_html__( 'Second Heading', 'master-addons' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        $this->add_control( 'ma_el_headlines_second_text_color', [
            'label'     => esc_html__( 'Text Color', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#132C47',
            'selectors' => [
                '{{WRAPPER}} .jltma-animated-heading .jltma-animated-heading-wrapper .jltma-animated-heading-title .second-heading' => 'color: {{VALUE}}; font-style: normal; font-weight: normal;',
            ],
        ] );
        $this->add_control( 'ma_el_headlines_second_bg_color', [
            'label'     => __( 'Background', 'master-addons' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .jltma-animated-heading .jltma-animated-heading-wrapper .jltma-animated-heading-title .second-heading' => 'background-color: {{VALUE}}; line-height:1.3;',
            ],
        ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [
        ...
        $this->add_control( 'ma_el_headlines_second_heading_padding', [
            'label'      => esc_html__( 'Padding', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors'  => [
        ...
        $this->add_control( 'ma_el_headlines_second_heading_margin', [
            'label'      => esc_html__( 'Margin', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors'  => [
        ...
        $this->add_control( 'ma_el_headlines_second_heading_radius', [
            'label'      => esc_html__( 'Border Radius', 'master-addons' ),
            'type'       => Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%'],
            'selectors'  => [
    ...
    protected function render() {
        ...
        ?>
		<div <?php 
        echo $this->get_render_attribute_string( 'jltma_animated_headlines' );
        ?>>
			<div class="jltma-animated-heading-wrapper">
				<<?php 
        echo tag_escape( $settings['title_html_tag'] ) . ' ' . $this->get_render_attribute_string( 'jltma_animated_header_wrapper' );
        ?>>
					<span class="first-heading">
						<?php 
        echo $this->parse_text_editor( $settings['ma_el_headlines_first_heading'] );
        ?>
					</span>
        ...
        foreach ( $settings['tabs'] as $index => $tab ) {
            ?>
							<b class="second-heading <?php 
            echo ( $index == 0 ? "is-visible" : "" );
            ?>">
								<?php 
            echo $this->parse_text_editor( $tab['ma_el_headlines_second_heading'] );
            ?>
							</b>
						<?php 
        }
