                ...
                <ul class="jltma-tabs jltma_menu_control_nav jltma-col-4">
                    <li id="content_nav" class="jltma-nav-item">
                        <a class="jltma-nav-link active" href="#content_tab">
                            <?php 
esc_html_e( 'Content', 'master-addons' );
?>
                        </a>
                    </li>
                    ...
                    <li id="general_nav" class="jltma-nav-item">
                        <a class="jltma-nav-link" href="#general_tab">
                            <?php 
esc_html_e( 'Settings', 'master-addons' );
?>
                        </a>
                    </li>
...
?>
                    ...
                    <li id="badge_nav" class="jltma-nav-item">
                        <a class="jltma-nav-link" href="#badge_tab">
                            <?php 
esc_html_e( 'Badge', 'master-addons' );
?>
                        </a>
                    </li>
...
if ( defined( 'ELEMENTOR_VERSION' ) ) {
    ...
    ?>
                                        ...
                                        <label for="jltma-menu-item-enable" class="jltma-switch">
                                            ...
                                            <span class="jltma-absolute-no"><?php 
    esc_html_e( 'NO' );
    ?></span>
                                        </label>
                                    </div>
                                ...
                                <button disabled type="button" id="jltma-menu-builder-trigger" class="jltma-menu-elementor-button content-edit-btn" data-toggle="modal" data-target="#jltma-mega-menu-builder-modal">
                                    <?php 
    esc_html_e( 'Edit Megamenu Content' );
    ?>
                                </button>
                            </div>
    ...
    ?>
                            <p class="no-elementor-notice">
                                <?php 
    esc_html_e( 'Elementor Page Builder required to Edit Megamenu Content', 'master-addons' );
    ?>
                            </p>
                        <?php 
}
                            ...
                            <div class="jltma-row">
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-5">
                                    <label for="jltma-megamenu-width-type">
                                        <strong>
                                            <?php 
esc_html_e( 'Mega Menu Width', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
...
esc_html_e( 'Default Width', 'master-addons' );
?></option>
                                        <option value="full_width"><?php 
esc_html_e( 'Full Width', 'master-addons' );
?></option>
                                        <option value="custom_width"><?php 
esc_html_e( 'Custom Width', 'master-addons' );
?></option>
                                    </select>
                            ...
                            <div class="jltma-row">
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-5">
                                    <label for="jltma-mobile-submenu-type">
                                        <strong>
                                            <?php 
esc_html_e( 'Mobile Menu', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                                <div class="jltma-form-group mb-2 jltma-col-7">
                                    <select class="jltma-form-control" id="jltma-mobile-submenu-type">
                                        <option value="submenu_list"><?php 
esc_html_e( 'WP Menu List', 'master-addons' );
?></option>
                                        <option value="builder_content" selected="selected"><?php 
esc_html_e( 'Builder Content', 'master-addons' );
?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="jltma-row">
                                <div class="jltma-form-group mb-2 jltma-col-5">
                                    <label for="mega-menu-trigger-effect">
                                        <strong>
                                            <?php 
esc_html_e( 'Trigger Effect', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
...
esc_html_e( 'Hover', 'master-addons' );
?></option>
                                        <option value="click"><?php 
esc_html_e( 'Click', 'master-addons' );
?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <!-- <div class="jltma-form-group mb-2 jltma-col-7">
                                    <label for="mega-menu-transition-effect">
                                        <strong>
                                        <?php 
//esc_html_e('Transition', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                                <div class="jltma-form-group mb-2 jltma-col-5">
                                    <select class="jltma-form-control" id="mega-menu-transition-effect">
                                        <option value="" selected="selected"><?php 
//echo esc_html__('Fade', 'master-addons' );
?></option>
                                        <option value="slide"><?php 
//esc_html_e('Slide Left', 'master-addons' );
?></option>
                                        <option value="slide-left"><?php 
//esc_html_e('Slide Right', 'master-addons' );
?></option>
                                        <option value="slide-down"><?php 
//esc_html_e('Slide Down', 'master-addons' );
?></option>
                                        <option value="slide-up"><?php 
//esc_html_e('Slide Up', 'master-addons' );
?></option>
                                        <option value="slide-up-fade"><?php 
//esc_html_e('Slide Up With Fade', 'master-addons' );
?></option>
                                        <option value="slide-down-fade"><?php 
//esc_html_e('Slide Down With Fade', 'master-addons' );
?></option>
                                        <option value="super-slidedown"><?php 
//esc_html_e('Super SlideDown', 'master-addons' );
?></option>
                                        <option value="zoom-inout"><?php 
//esc_html_e('Zoom In/Out', 'master-addons' );
?></option>
                                        <option value="flip-effect"><?php 
//esc_html_e('Flip Effect', 'master-addons' );
?></option>
                                    </select>
                                </div> -->
                            ...
                            <div class="jltma-row">
                                <div class="jltma-form-group mb-2 jltma-col-6 <?php 
echo "jltma-disabled";
?>">
                                    <label for="mega-menu-hide-item-label">
                                        <strong>
                                            <?php 
esc_html_e( 'Show Menu Label', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                                <div class="jltma-form-group mb-2 jltma-col-6 jtlma-mega-switcher <?php 
echo "jltma-disabled";
?>">
...
?>">
                                    <label for="mega-menu-hide-item-label">
                                        <strong>
                                            <?php 
esc_html_e( 'Show Description', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                    ...
                    <div class="jltma-tab-pane" id="icon_tab">
                        ...
                        <div class="option-table jltma-label-container">
                            <div class="jltma-row">
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-7 <?php 
echo "jltma-disabled";
?>">
                                    <label for="jltma-menu-icon-field">
                                        <strong>
                                            <?php 
esc_html_e( 'Menu Icon', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>

                                <div class="jltma-form-group mb-2 jltma-col-5 <?php 
echo "jltma-disabled";
?>">
...
?>">
                                    <label for="jltma-menu-icon-color-field">
                                        <strong>
                                            <?php 
esc_html_e( 'Icon Color', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                            ...
                            <div class="jltma-row">
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-7">
                                    <label for="jltma-menu-badge-text-field">
                                        <strong>
                                            <?php 
esc_html_e( 'Badge Text', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
...
esc_html_e( 'Badge Text', 'master-addons' );
?>" id="jltma-menu-badge-text-field" />
                                </div>
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-7">
                                    <label for="jltma-menu-badge-color-field">
                                        <strong>
                                            <?php 
esc_html_e( 'Badge Color', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
                                ...
                                <div class="jltma-form-group mb-2 jltma-col-7">
                                    <label for="jltma-menu-badge-background-field">
                                        <strong>
                                            <?php 
esc_html_e( 'Background', 'master-addons' );
?>
                                        </strong>
                                    </label>
                                </div>
