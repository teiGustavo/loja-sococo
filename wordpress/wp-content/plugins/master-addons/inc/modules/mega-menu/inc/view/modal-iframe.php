    ...
    <div class="jltma-modal-dialog modal-dialog-centered">
        <div class="jltma-modal-content">
            <div class="jltma-modal-body">
                ...
                <iframe id="jltma-menu-builder-iframe" src="<?php echo get_rest_url() . 'masteraddons/v2/mastermega-content/jltma_content_editor/megamenu/menuitem'; ?>" frameborder="0"></iframe>
            </div>
        </div>
    </div>
</div>
