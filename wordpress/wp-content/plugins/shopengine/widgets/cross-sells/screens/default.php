...
$shopengine_cross_sells_product_column_gap = $this->get_settings_for_display('shopengine_cross_sells_product_column_gap');
$shopengine_cross_sells_product_column_gap = isset($shopengine_cross_sells_product_column_gap['size']) ? $shopengine_cross_sells_product_column_gap : ['size' => 10];
...
$columns	= $is_slider_enable ? $shopengine_cross_sells_product_slider_perview : $shopengine_cross_sells_product_column_gap['size'];
